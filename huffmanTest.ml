...
let compTest = Test.make ~count:1000
                         ~name:"String is completely reconstructed with no change"
...
let noChange = Test.make ~count:1000
                         ~name:"The string remains same after comp and decomp"
